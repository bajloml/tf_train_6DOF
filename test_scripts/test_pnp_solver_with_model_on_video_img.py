...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_video', help='use video if true, use image_path if false')
    parser.add_argument('--img_path', help='path to image to test on')
    ...
    debugFolderPath = os.path.join(dir_path, 'DEBUG_pnp_solver_on_video_img{}'.format(opt.model), str(opt.outf))
        ...
        try:
            ...
            if use_video:
                ...
                while (videoCap.isOpened()):
                    ...
                    # model prediction
                    rot_pred, tran_pred, test_img, _ = ps_prediction.getPosition(logits_beliefs, logits_affinities, tf.squeeze(imgTensor))
